...
namespace ClosedXML_Examples
{
    public class PivotTableStyles : IXLExample
    {
        ...
        public static XLWorkbook Create()
        {
            ...
            companyField.AddHeaderStyle().Style.Font.SetFontSize(10);
            companyField.AddLabelStyle().Style.Fill.BackgroundColor = brightYellow;
            var subtotalStyle = companyField.AddSubtotalStyle(XLPivotStyleFormatElement.All);
            subtotalStyle.Style.Fill.BackgroundColor = purpleBlue;
            subtotalStyle.Style.Font.SetFontSize(9);
            subtotalStyle.Style.Font.SetItalic(true);
            subtotalStyle.Style.Font.FontColor = XLColor.White;

            payMethodField.AddHeaderStyle().Style.Font.SetBold();
            payMethodField.AddHeaderStyle().Style.Font.SetFontSize(10);
            payMethodField.AddLabelStyle().Style.Fill.BackgroundColor = purpleBlue;
            payMethodField.AddLabelStyle().Style.Font.FontColor = XLColor.White;
            payMethodField.AddSubtotalStyle(XLPivotStyleFormatElement.All).Style.Fill.BackgroundColor = gray;

            orderNoField.AddHeaderStyle().Style.Font.SetBold();
            orderNoField.AddHeaderStyle().Style.Font.SetFontSize(10);
            orderNoField.AddLabelStyle().Style.Fill.BackgroundColor = purpleBlue;
            orderNoField.AddLabelStyle().Style.Font.FontColor = XLColor.White;

...
namespace ClosedXML.Excel
{
    public abstract class XLValidationCriteria : IXLValidationCriteria
    {
        ...
        {
            dataValidation.Value = String.Format("'{0}'!{1}", ((XLRange)range).Worksheet.Name, range.RangeAddress.ToString());
            dataValidation.Operator = XLOperator.EqualTo;
        }
        ...
        {
            dataValidation.MinValue = String.Format("'{0}'!{1}", ((XLRange)minValue).Worksheet.Name, minValue.RangeAddress.ToString());
            dataValidation.MaxValue = String.Format("'{0}'!{1}", ((XLRange)maxValue).Worksheet.Name, maxValue.RangeAddress.ToString());
            dataValidation.Operator = XLOperator.Between;
        }
        ...
        {
            dataValidation.Value = String.Format("'{0}'!{1}", cell.Worksheet.Name, cell.Address.ToString());
            dataValidation.Operator = XLOperator.EqualTo;
        }
        ...
        {
            dataValidation.MinValue = String.Format("'{0}'!{1}", minValue.Worksheet.Name, minValue.Address.ToString());
            dataValidation.MaxValue = String.Format("'{0}'!{1}", maxValue.Worksheet.Name, maxValue.Address.ToString());
            dataValidation.Operator = XLOperator.Between;
        }

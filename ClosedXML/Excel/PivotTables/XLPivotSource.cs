...
namespace ClosedXML.Excel
{
    internal class XLPivotSource : IXLPivotSource
    {
        ...
        private XLPivotSource()
        {
            ...
            CachedFields = new Dictionary<String, IList<XLCellValue>>(StringComparer.OrdinalIgnoreCase);
            SetExcelDefaults();
        }

        public IDictionary<String, IList<XLCellValue>> CachedFields { get; internal set; }

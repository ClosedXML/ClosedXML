...
public interface IXLPivotFields : IEnumerable<IXLPivotField>
{
    ...
    /// <param name="customName">Display name of added field. Ignored for 'data' field.</param>
    /// <returns>The added field.</returns>
    /// <exception cref="ArgumentException">Field can't be added (e.g. it is already used or can't be added to specific collection).</exception>
    IXLPivotField Add(String sourceName, String customName);

    /// <summary>
    /// Remove all fields from the axis. It also removes related data, like custom names and items.
    /// </summary>
    void Clear();

    /// <summary>
    /// Does axis contain a field?
    /// </summary>
    ...
    /// <summary>
    /// Get index of a field in the collection.
    /// </summary>

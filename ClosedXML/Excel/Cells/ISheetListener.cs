namespace ClosedXML.Excel
{
    ...
    internal interface ISheetListener
    {
        ...
        void OnInsertAreaAndShiftDown(XLWorksheet sheet, Area area);
        ...
        void OnInsertAreaAndShiftRight(XLWorksheet sheet, Area area);
        ...
        void OnDeleteAreaAndShiftLeft(XLWorksheet sheet, Area deletedRange);
        ...
        void OnDeleteAreaAndShiftUp(XLWorksheet sheet, Area deletedRange);
    }
}

...
namespace ClosedXML.Excel
{
    ...
    public partial class XLWorkbook : IXLWorkbook
    {
        ...
        {
            get { return _calcEngine ?? (_calcEngine = new XLCalcEngine(CultureInfo.CurrentCulture)); }
        }
        ...
        {
            get { return _calcEngineExpr ?? (_calcEngineExpr = new XLCalcEngine(CultureInfo.InvariantCulture)); }
        }

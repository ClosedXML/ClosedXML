...
namespace ClosedXML.Excel
{
    public partial class XLColor
    {
        ...
        internal static XLColor FromVmlColor(String vmlColor)
        {
            ...
            // palette index if found, it is a legacy feature from times of 256 colors.
            var paletteIndexStart = vmlColor.IndexOf('[');
            var hasPaletteIndex = paletteIndexStart >= 0;
            var paletteColorName = hasPaletteIndex ? vmlColor[..paletteIndexStart] : vmlColor;
            paletteColorName = paletteColorName.Trim();

...
namespace ClosedXML.Excel
{
    internal class XLRange : XLRangeBase, IXLRange
    {
        ...
        internal void WorksheetRangeShiftedColumns(object sender, RangeShiftedEventArgs e)
        {
            ShiftColumns(RangeAddress, e.Range, e.Shifted);
        }

        internal void WorksheetRangeShiftedRows(object sender, RangeShiftedEventArgs e)
        {

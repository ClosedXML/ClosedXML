...
namespace ClosedXML.Utils
{
    internal static class OpenXmlHelper
    {
        ...
        /// <param name="colorCache">The dictionary containing parsed colors to optimize performance.</param>
        /// <returns>The color in ClosedXML format.</returns>
        private static XLColor ConvertToClosedXMLColor(this X14.ColorType openXMLColor, IDictionary<string, Drawing.Color> colorCache )
        {
            XLColor retVal = null;
        ...
        /// <param name="colorCache">The dictionary containing parsed colors to optimize performance.</param>
        /// <returns>The color in ClosedXML format.</returns>
        private static XLColor ConvertToClosedXMLColor(this ColorType openXMLColor, IDictionary<string, Drawing.Color> colorCache )
        {
            XLColor retVal = null;
            if (openXMLColor != null)
            {
        ...
        /// <param name="isDifferential">Flag specifiying that the color should be saved in
        /// differential format (affects the transparent color processing).</param>
        private static void FillFromClosedXMLColor(this ColorType openXMLColor, XLColor xlColor, bool isDifferential)
        {
            if (openXMLColor == null)
        ...
        /// <param name="isDifferential">Flag specifiying that the color should be saved in
        /// differential format (affects the transparent color processing).</param>
        private static void FillFromClosedXMLColor(this X14.ColorType openXMLColor, XLColor xlColor, bool isDifferential)
        {
            if (openXMLColor == null)
                throw new ArgumentNullException(nameof(openXMLColor));

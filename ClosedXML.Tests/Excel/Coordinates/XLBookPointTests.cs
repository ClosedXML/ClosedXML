...
internal class SheetPointTests
{
    ...
    {
        var first = new SheetPoint(firstName, firstRow, firstColumn);
        var second = new SheetPoint(secondName, secondRow, secondColumn);
    ...
    {
        var bookPoint = new SheetPoint(name, row, column);

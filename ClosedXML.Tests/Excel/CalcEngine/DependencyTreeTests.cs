...
namespace ClosedXML.Tests.Excel.CalcEngine
{
    ...
    internal class DependencyTreeTests
    {
        ...
        public void Area_dependencies_are_extracted_from_formula(string formula, IReadOnlyList<SheetArea> expectedAreas)
        {
        ...
        public void Name_range_is_added_to_dependencies_of_formula()
        {
            ...
            CollectionAssert.AreEquivalent(new SheetArea[]
            {
        ...
        private static XLCellFormula AddFormula(DependencyTree tree, IXLWorksheet sheet, string address, string formula)
        {
            ...
            var cellArea = new SheetArea(sheet.Name, new Area(cell.Point, cell.Point));
